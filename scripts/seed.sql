-- ==========================================
-- AgeGate — Seed Data for Supabase
...
VALUES
  ('plan_free',      'Free',      'free',      'Up to 1,000 MAU. Perfect for indie devs.',        0,     1000,   '["basic_age_gate","email_support","standard_modal","community_access"]', 'price_free',      now()),
  ('plan_starter',   'Starter',   'starter',   'Up to 10,000 MAU. Priority email support.',      2900,  10000,  '["basic_age_gate","priority_email","custom_branding","webhook_logs","analytics"]', 'price_starter',   now()),
  ('plan_growth',    'Growth',    'growth',    'Up to 100,000 MAU. Webhook logs + custom branding.', 9900, 100000, '["advanced_age_gate","priority_email","custom_branding","webhook_logs","analytics","api_access"]', 'price_growth',    now()),
  ('plan_enterprise','Enterprise','enterprise','Unlimited MAU. Dedicated Slack + SLA.',            29900, 999999999,'["advanced_age_gate","dedicated_slack","sla_99_9","custom_branding","webhook_logs","analytics","api_access","audit_logs"]', 'price_enterprise',now())
...
VALUES
  ('00000000-0000-0000-0000-000000000001', 'demo@agegate.dev', '{"full_name":"Demo User"}', now(), now())
...
VALUES
  ('key_demo_001', '00000000-0000-0000-0000-000000000001', 'Demo Key', 'agegate_demo_xxxxxxxxxxxxxxxx', '["verify:write","analytics:read"]', now(), now())
ON CONFLICT (id) DO NOTHING;
